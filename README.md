...
- **Импорт** — CSV с предпросмотром, проверкой справочников и защитой целостности переводов
...
src/
  ...
  components/
    ...
    ImportOperationsModal.jsx  — проверка и импорт CSV
...
`workspaces`, `workspace_members`, `operations`, `categories`, `tags`, `operation_tags`, `accounts`, `scheduled_operations`, `debts`, `budgets`, `ai_access_policies`, `ai_assistant_logs`, `telegram_users`
