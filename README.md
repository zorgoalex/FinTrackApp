...
`workspaces`, `workspace_members`, `operations`, `categories`, `category_rules`, `tags`, `operation_tags`, `accounts`, `scheduled_operations`, `cashflow_plans`, `debts`, `budgets`, `notification_preferences`, `app_notifications`, `import_sessions`, `operation_comments`, `ai_access_policies`, `ai_assistant_logs`, `telegram_users`
