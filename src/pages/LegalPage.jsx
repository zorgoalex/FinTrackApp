    ...
    <main className="min-h-screen bg-gray-50 px-4 py-8 text-gray-800 dark:bg-gray-900 dark:text-gray-100 sm:py-12">
      <article className="mx-auto max-w-3xl space-y-8 rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-10">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-6">В закрытой beta офлайн-работа с финансовыми данными отключена: справочники и несинхронизированные операции не сохраняются для работы без сети. Для входа и работы требуется подключение к интернету; ранее созданное offline-хранилище FinTrackApp удаляется автоматически.</p>
