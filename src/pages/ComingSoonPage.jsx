  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-200 dark:border-gray-700 p-8 max-w-sm w-full text-center">
        ...
        <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">В процессе разработки</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Этот раздел ещё не готов.</p>
