...
export default function MonthPicker({ year, month, onChange }) {
  ...
  return (
    <div className="flex items-center gap-2" data-testid="month-picker">
      <button
        onClick={handlePrev}
        className="grid min-h-11 min-w-11 place-items-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400 transition-colors"
      ...
      {!isCurrent && (
        <button
          onClick={handleToday}
          className="ml-1 min-h-11 text-xs px-3 py-2 rounded-lg border border-primary-300 dark:border-primary-600 text-primary-600 dark:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/30 transition-colors"
